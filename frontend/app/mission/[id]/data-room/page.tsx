...
import { Database, ArrowRight, Download, CloudUpload, CheckCircle2, ExternalLink } from 'lucide-react';
...
export default function DataRoomPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const { userMissions, syncMissionProgress, loading: authLoading, markDatasetSynced, profile } = useAuth();
                    ...
                    <div className="grid gap-4">
                        {datasets.map((dataset) => {
                            ...
                            return (
                                ...
                                >
                                    <div className="h-12 w-12 rounded-lg flex items-center justify-center shrink-0 transition-colors bg-indigo-100 text-indigo-600">
                                    ...
                                    <Badge variant="success" className="bg-green-100 text-green-700">Access Granted</Badge>
                                </div>
                            );
                        })}
                    </div>
